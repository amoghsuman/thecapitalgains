      ...
      <div className="flex flex-col">
        {events.map((event, i) => (
          <div key={i} className="relative pl-8 pb-8 last:pb-0">
            {i < events.length - 1 && <div className="absolute left-[7px] top-4 bottom-0 w-px bg-gold/40" />}
            <div className="absolute left-0 top-1.5 w-4 h-4 rounded-full bg-forest border-2 border-panel shadow-[0_0_0_1px_#A9822F]" />
