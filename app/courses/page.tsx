...
function AccessBadge({ level }: { level?: string }) {
  ...
  return <span className="font-mono text-[10px] font-medium bg-[rgba(17,17,17,0.1)] text-[#111111] rounded px-2 py-1">LEARNER+</span>;
}
    ...
    <div className="bg-[#FAFAF7] min-h-screen">
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        ...
        <div className="pt-14 pb-10">
          ...
          <h1 className="font-serif text-5xl font-bold text-[#111111] leading-[1.1]">
            All Courses
          </h1>
