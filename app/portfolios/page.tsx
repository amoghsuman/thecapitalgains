...
const portfolios = [
  {
    ...
    bars: [
      { label: "Large Cap", pct: 80, color: "bg-[#0F2348]" },
  ...
  },
  {
    ...
    bars: [
      { label: "Dividend Stocks", pct: 70, color: "bg-[#0F2348]" },
  ...
  },
  {
    ...
    bars: [
      { label: "Large Cap F&O", pct: 60, color: "bg-[#0F2348]" },
  ...
  return (
    <div className="bg-[#FAFAF7] min-h-screen overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {portfolios.map((p) => (
            ...
            >
              ...
              <div className="font-serif text-[18px] text-[#0F2348] mb-3 leading-snug">
                {p.name}
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-5">
                {p.stats.map((s) => (
                  <div key={s.label} className="bg-[#F4F1EB] rounded-lg p-3">
                    ...
                    <div className={`font-mono text-[13px] font-medium text-[#0F2348] ${s.color}`}>
                      {s.val}
                    </div>
                  </div>
                ))}
              ...
              <div>
                ...
                <div className="flex flex-col gap-0">
                  {p.holdings.map((h, i) => (
                    ...
                    >
                      <div>
                        <div className="font-mono text-[12px] font-medium text-[#0F2348]">
                          {h.name}
                        </div>
      ...
      <section className="max-w-6xl mx-auto px-8 mt-16">
        <div className="bg-[#0F2348] rounded-2xl px-10 py-10">
      ...
      <section className="max-w-6xl mx-auto px-8 mt-12">
        <div className="bg-[#FDF3E3] border border-[rgba(212,134,10,0.2)] rounded-2xl px-10 py-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            ...
            <h3 className="font-serif text-[24px] font-bold text-[#0F2348] mb-2">
      ...
      <section className="max-w-6xl mx-auto px-8 pb-10 mt-8">
        <div className="bg-white border border-[rgba(15,35,72,0.08)] rounded-lg px-6 py-5 font-mono text-[10px] text-[#9494A8] leading-relaxed">
